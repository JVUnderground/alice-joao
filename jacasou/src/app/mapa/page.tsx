export default function Mapa() {
    return (
      <>
        <div>
          <h1 className="text-4xl text-center font-heybrights">Mapa</h1>
          <p className="text-center text-lg mt-5">
          Av. Édison Passos, 4200 - Alto da Boa Vista, Rio de Janeiro - RJ
          </p>
        </div>
        <div className="w-full h-96 md:h-[700px] flex justify-center">
          <iframe
