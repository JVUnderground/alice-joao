...
export const WeddingIntroduction = () => {
    return (
        <div className="flex justify-center p-10">
            <div className="bg-white shadow-lg rounded-lg p-6 text-lg w-full max-w-2xl ">
                ...
                <p className="text-justify indent-8">
                    Estamos muito felizes em ter vocês ao nosso lado neste momento tão importante. Para nossa Lua de Mel, decidimos criar uma lista de presentes dedicada à viagem. Cada contribuição será um passo a mais rumo à viagem.
                ...
                <p className="mt-4 font-motterdam text-2xl md:text-4xl">
                    Com carinho,<br />
                    João e Alice<br />
